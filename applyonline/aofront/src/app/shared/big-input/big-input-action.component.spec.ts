...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<aofront-big-input-action></aofront-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<aofront-big-input-action [disabled]="true"></aofront-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<aofront-big-input-action fontSet="fas" fontIcon="fa-trash"></aofront-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<aofront-big-input-action label="delete"></aofront-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<aofront-big-input-action (action)="actionHandler()"></aofront-big-input-action>`;
    fixture = createHostComponent(template);
